    ...
    <aside class="w-64 bg-[#1b2533] flex flex-col hidden md:flex z-20 shrink-0 text-gray-300">
        <div class="h-24 flex items-center px-6 border-b border-gray-700/30 mb-4 mt-2">
            <div class="w-12 h-12 bg-[#D98324] rounded-xl flex items-center justify-center text-white mr-3 shadow-md">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M4 4h6v6H4V4zm10 0h6v6h-6V4zM4 14h6v6H4v-6zm11 1h2v-2h2v2h2v2h-2v2h-2v-2h-2v-2z"></path></svg>
            </div>
            <div>
        ...
        <nav class="flex-1 px-4 space-y-6 overflow-y-auto pb-4">
            <div>
                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-xl transition-all font-bold text-sm">
                    <svg class="w-5 h-5 mr-3 opacity-70" fill="currentColor" viewBox="0 0 20 20"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg> Dashboard
                </a>
            </div>

            <div>
                <p class="px-4 text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-3">User Management</p>
                <a href="{{ route('admin.students') }}" class="flex items-center px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-xl transition-all font-medium text-sm">
                    <svg class="w-5 h-5 mr-3 opacity-70" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg> Students
                </a>
                
                <a href="{{ route('admin.lecturers') }}" class="flex items-center px-4 py-3 bg-[#D98324] text-white rounded-xl font-bold transition-all shadow-md text-sm mt-1">
            ...
            <div>
                ...
                <a href="#" class="flex items-center px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-xl transition-all font-medium text-sm mt-1">
                    <svg class="w-5 h-5 mr-3 opacity-70" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg> Assessments
                </a>
                <a href="#" class="flex items-center px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-xl transition-all font-medium text-sm mt-1">
        ...
        <div class="p-4 border-t border-gray-700/30">
            <div class="flex items-center justify-between">
                <div class="flex items-center cursor-pointer">
                    <div class="w-11 h-11 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold text-sm tracking-wide mr-3 shadow-inner">AU</div>
                    <div>
        ...
        <div class="flex-1 overflow-y-auto p-6 md:p-10 relative">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    <div>
                        <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Manajemen Dosen</h2>
                        <p class="text-sm text-gray-500 mt-1">Manage lecturer profiles, academic roles, and platform access.</p>
                    </div>
                ...
                <div class="bg-white p-4 rounded-t-2xl border-t border-l border-r border-gray-200 shadow-sm flex flex-col md:flex-row items-center gap-4">
                    <div class="flex items-center gap-4 w-full md:w-auto">
                        <div class="flex items-center text-sm text-gray-600">
                            <span class="mr-2">Department:</span>
                            <select class="bg-gray-50 border border-gray-200 text-gray-700 rounded-lg focus:ring-[#D98324] focus:border-[#D98324] block w-40 p-2 text-sm">
                                <option>All Departments</option>
                            </select>
                        </div>
                        <div class="flex items-center text-sm text-gray-600">
                            <span class="mr-2">Status:</span>
                            <select class="bg-gray-50 border border-gray-200 text-gray-700 rounded-lg focus:ring-[#D98324] focus:border-[#D98324] block w-32 p-2 text-sm">
                    ...
                    <div class="relative w-full md:w-64">
                        ...
                        <input type="text" class="w-full bg-gray-50 border border-gray-200 text-gray-700 placeholder-gray-400 rounded-lg pl-10 pr-4 py-2 focus:ring-1 focus:ring-[#D98324] focus:border-[#D98324] text-sm transition" placeholder="Search...">
                    </div>
                </div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold mr-3 shrink-0">
                                                {{ strtoupper(substr($dosen->nama ?? 'D', 0, 2)) }}
                                            </div>
                                            <div>
                                                <p class="font-bold text-gray-900">{{ $dosen->nama }}</p>
                                                <p class="text-[11px] text-gray-500">{{ $dosen->email }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 font-mono text-xs text-gray-500">{{ $dosen->nim_nidn ?? '-' }}</td>
                                    <td class="px-6 py-4 text-gray-600">Teknik Informatika</td> <td class="px-6 py-4 text-gray-600">Dosen Pengajar</td> <td class="px-6 py-4">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm transition-opacity">
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden transform transition-all">
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100">
                    <h3 class="text-lg font-bold text-gray-900">Add New Lecturer</h3>
                    <button wire:click="closeModal" class="text-gray-400 hover:text-red-500 transition">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                    </button>
                </div>
                
                <form wire:submit.prevent="simpanDosen" class="p-6 space-y-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Full Name with Title</label>
                        <input type="text" wire:model="nama" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-[#D98324] focus:border-transparent text-sm" placeholder="e.g. Dr. Sarah Jenkins" required>
                        @error('nama') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                    </div>
                    
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">NIP / ID</label>
                        <input type="text" wire:model="nim_nidn" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-[#D98324] focus:border-transparent text-sm" placeholder="e.g. 198504122010122001" required>
                        @error('nim_nidn') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                    </div>
                    
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Email Account</label>
                        <input type="email" wire:model="email" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-[#D98324] focus:border-transparent text-sm" placeholder="sarah.j@siminat.edu" required>
                        @error('email') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Temporary Password</label>
                        <input type="password" wire:model="password" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-[#D98324] focus:border-transparent text-sm" placeholder="Minimum 6 characters" required>
                        @error('password') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                    </div>

                    <div class="pt-4 flex justify-end gap-3">
                        <button type="button" wire:click="closeModal" class="px-5 py-2.5 text-sm font-bold text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 transition">Cancel</button>
                        <button type="submit" class="px-5 py-2.5 text-sm font-bold text-white bg-[#D98324] rounded-lg hover:bg-[#c27520] shadow-md transition flex items-center">
                            <span wire:loading.remove wire:target="simpanDosen">Save Lecturer</span>
                            <span wire:loading wire:target="simpanDosen">Saving...</span>
                        </button>
                    </div>
                </form>
            </div>
