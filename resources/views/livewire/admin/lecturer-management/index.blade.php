                                ...
                                <tr style="border-bottom:1px solid rgba(26,35,64,0.04);"
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            <button wire:click="openModal({{ $lecturer->id }})"
                                                    class="p-1.5 rounded-lg transition-all"
                                                    style="color:#C8922A;" title="Edit">
                                                <i class="ti ti-pencil text-base"></i>
                                            </button>
                                            <button wire:click="hapus({{ $lecturer->id }})"
                                                    wire:confirm="Hapus dosen {{ $lecturer->nama }}? Tindakan ini tidak dapat dibatalkan."
                                                    class="p-1.5 rounded-lg transition-all"
            ...
            <div class="sim-card w-full max-w-md p-6" style="max-height:90vh;overflow-y:auto;">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input wire:model="nama" type="text" placeholder="Nama lengkap dosen"
                    ...
                    <div>
                        ...
                        <input wire:model="email" type="email" placeholder="email@polsub.ac.id (opsional)"
                               class="w-full px-4 py-2.5 rounded-xl text-sm outline-none"
                               style="border:1.5px solid rgba(26,35,64,0.15);background:#fff;color:#1A2340;"
                               onfocus="this.style.borderColor='#C8922A'"
                               onblur="this.style.borderColor='rgba(26,35,64,0.15)'">
                ...
                <div class="flex gap-3 mt-6">
                    ...
                    <button wire:click="simpanDosen()" class="flex-1 sim-btn-gold text-sm justify-center">
